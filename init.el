...
values."
  (setq-default
   ...
   '(
     ...
     ;; ----------------------------------------------------------------
     (spacemacs-editing :packages aggressive-indent eval-sexp-fu expand-region hungry-delete undo-tree ws-butler smartparens)
     spacemacs-ui-visual
   ...
   dotspacemacs-additional-packages '(bbdb ag)
